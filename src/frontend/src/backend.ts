...
import type { Announcement as _Announcement, AnnouncementId as _AnnouncementId, ExternalBlob as _ExternalBlob, Product as _Product, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createAnnouncement(arg0: string, arg1: string, arg2: ExternalBlob | null): Promise<Announcement> {
        if (this.processError) {
            try {
                const result = await this.actor.createAnnouncement(arg0, arg1, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg2));
                return from_candid_Announcement_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async createProduct(arg0: string, arg1: bigint, arg2: string, arg3: ExternalBlob | null): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.createProduct(arg0, arg1, arg2, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg3));
    ...
    async getAnnouncement(arg0: AnnouncementId): Promise<Announcement> {
        if (this.processError) {
            try {
    ...
    async initializeAdmins(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeAdmins();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listPublishedAnnouncements(): Promise<Array<Announcement>> {
        if (this.processError) {
            try {
                const result = await this.actor.listPublishedAnnouncements();
                return from_candid_vec_n22(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetCatalog(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetCatalog();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async seedInitialProducts(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.seedInitialProducts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAnnouncement(arg0: AnnouncementId, arg1: string, arg2: string, arg3: ExternalBlob | null, arg4: boolean): Promise<Announcement> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAnnouncement(arg0, arg1, arg2, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg3), arg4);
                return from_candid_Announcement_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: ProductId, arg1: string, arg2: bigint, arg3: string, arg4: ExternalBlob | null, arg5: boolean): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(arg0, arg1, arg2, arg3, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg4), arg5);
                return from_candid_Product_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Announcement_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Announcement): Promise<Announcement> {
...
async function from_candid_vec_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Announcement>): Promise<Array<Announcement>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Announcement_n12(_uploadFile, _downloadFile, x)));
}
